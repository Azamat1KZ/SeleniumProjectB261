...
public class ConfigurationReader {
    ...
    // having static block because static runs first, because in this clas we don't have Main method or TestNg to run the class so we will need a "Static block" (which will run one time when we call the class no matter what )
