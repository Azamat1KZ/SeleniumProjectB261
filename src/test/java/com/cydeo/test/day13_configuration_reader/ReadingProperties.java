...
public class ReadingProperties {
    ...
    public void reading_from_properties_file() throws IOException {
        ...
        //Create Properties class' object. We need Properties class to use getProperty("key") method
        ...
        //We can use properties.getProperties method to read from the file we loaded. (configuration.properties)
